...
const GoogleIcon: React.FC<GoogleIconType> = ({ className }) => {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <g clip-path="url(#clip0_1601_1006)">
        <path
          d="M11.9998 9.81836V14.4656H18.4579C18.1743 15.9602 17.3233 17.2257 16.047 18.0766L19.9415 21.0984C22.2106 19.0039 23.5197 15.9276 23.5197 12.273C23.5197 11.4221 23.4433 10.6039 23.3015 9.81849L11.9998 9.81836Z"
          fill="#4285F4"
        />
        <path
